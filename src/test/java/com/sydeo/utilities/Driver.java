...
public class Driver {
    ...
    // Creating private constructor , so we are closing access to the object of this class from outside of any classes
    private Driver(){}


    /*
        Making our 'driver' instance private,so that it is not reachable from outside of any class
        We make it static because we want it run before anything else,
